...
def main():
    ...
    output_queries_path = here / "tmp/subset_quest_queries.jsonl"
    output_documents_path = here / "tmp/subset_documents.jsonl"
    output_summary_path = here / "tmp/subset_summary.json"
