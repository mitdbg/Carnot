...
class Dataset:
    ...
    def run(self, config: QueryProcessorConfig | None = None, **kwargs):
        ...
        from carnot.query_processor_factory import QueryProcessorFactory
    ...
    def optimize_and_run(self, config: QueryProcessorConfig | None = None, train_dataset: dict[str, Dataset] | Dataset | None = None, validator: None = None, **kwargs):
        """Optimize the PZ program using the train_dataset and validator before running the optimized plan."""
        # TODO: ultimately we should implement this; but not including for now to avoid a ton of imports
