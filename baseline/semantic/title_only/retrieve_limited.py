...
# --- Configuration ---
# Updated to match your indexing script
...
OUTPUT_PREDICTIONS_PATH = "pred_unranked_limited_subset3.jsonl"
...
def retrieve(queries_path: str, output_path: str):
    ...
    with open(output_path, "w", encoding="utf-8") as f_out:
        ...
        for item in tqdm(queries, desc="Retrieving documents"):
            ...
            # Get the 'title' from each document's metadata
            top_100_docs = [meta["title"] for meta in retrieved_metadatas]
    ...
    print(f"\n--- Done! ---")
    print(f"Successfully wrote {len(queries)} predictions to '{OUTPUT_PREDICTIONS_PATH}'.")
