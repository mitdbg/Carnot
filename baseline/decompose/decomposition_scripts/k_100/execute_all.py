#!/usr/bin/env python3
# execute_all.py for k=100 - RETRIEVAL ONLY (NO TRUNCATION)
...
def main():
    ...
    for i in tqdm(range(num_to_process), desc="Executing all query strategies for k=100"):
    ...
    print(f"\n--- All strategies executed for k=100. ---")
