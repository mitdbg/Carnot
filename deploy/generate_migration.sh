...
sleep 10
CONTAINER_NAME=$(docker compose ps -q web-backend)
...
echo "🛠 Generating Alembic revision inside container..."
docker exec -it $CONTAINER_NAME alembic revision --autogenerate -m "Initial migration"
