try:
    ...
    from parsers.carnot_deep_research import CarnotDeepResearchParser
    from parsers.openai_deepresearch import OpenAIDeepResearchParser
except ImportError:
    ...
    from .carnot_deep_research import CarnotDeepResearchParser
    from .openai_deepresearch import OpenAIDeepResearchParser
import logging
...
def get_parser(config: dict, folder_path: str):
    ...
    elif parser_type == ParserType.CARNOT_DEEP_RESEARCH:
        return CarnotDeepResearchParser(folder_path, config)
    elif parser_type == ParserType.OPENAI_DEEPRESEARCH:
        return OpenAIDeepResearchParser(folder_path, config)
    else:
